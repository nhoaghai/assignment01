                ...
                <div class="modal-content">
                    <form action="editP" method="post">
                        <div class="modal-header">						
                            <h4 class="modal-title">Edit Teddy Bear</h4>
                        </div>
                        <div class="modal-body">	
                            <div class="form-group">
                                <label>ID:</label>
                                <input value="${detail.productId}" name="productId" type="text" class="form-control" required readonly>
                            </div>
                            <div class="form-group">
                                <label>Name:</label>
                            ...
                            <div class="form-group">
                                <label>Price:</label>
                                <input value="${detail.unitPrice}" name="unitPrice" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <a href="listP" class="back-to-home">Cancel</a>
